...
namespace MLMS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241223174900_AddCourses")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseMajor", b =>
                {
                    b.Property<int>("AssignedMajorsId")
                        .HasColumnType("int");

                    b.Property<long>("CoursesAssignedToId")
                        .HasColumnType("bigint");

                    b.HasKey("AssignedMajorsId", "CoursesAssignedToId");

                    b.HasIndex("CoursesAssignedToId");
            ...
            modelBuilder.Entity("MLMS.Domain.Questions.Choice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MLMS.Domain.Questions.Question", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MLMS.Domain.UserSectionParts.UserSectionPartExamState", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserSectionPartExamState", (string)null);
                });
            ...
            modelBuilder.Entity("CourseMajor", b =>
                {
                    b.HasOne("MLMS.Domain.Majors.Major", null)
                        .WithMany()
                        .HasForeignKey("AssignedMajorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MLMS.Domain.Courses.Course", null)
                        .WithMany()
                        .HasForeignKey("CoursesAssignedToId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MLMS.Domain.Questions.Choice", b =>
                {
                    b.HasOne("MLMS.Domain.Questions.Question", "Question")
                        .WithMany("Choices")
