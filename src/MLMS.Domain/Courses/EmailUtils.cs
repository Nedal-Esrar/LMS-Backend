                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="padding-top:0px;padding-left:20px;padding-bottom:0px;padding-right:20px" bgcolor="#ffffff">
                                                            <p style="color:#05192d;font-family:StudioFeixenSans,'StudioFeixenSans',Arial,sans-serif;font-size:16px;line-height:26px;font-weight:normal">The course {courseName} has been assigned to you you can check it from your LMS Dashboard. Happy Learning :)</p>
                                                        </td>
                                                    </tr>
                                        ...
                                        <td class="m_-533078734955811462one-column" align="center" style="padding-left:10px;padding-right:10px">
                                            ...
                                            <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-radius:4px;background-color:#efebe4" bgcolor="#efebe4">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="padding-top:0px;padding-left:20px;padding-bottom:0px;padding-right:20px" bgcolor="#ffffff">
                                                            <p style="color:#05192d;font-family:StudioFeixenSans,'StudioFeixenSans',Arial,sans-serif;font-size:16px;line-height:26px;font-weight:normal">The course {courseName} has been unassigned from you. Don't Forget Other Courses!</p>
                                                        </td>
                                                    </tr>
